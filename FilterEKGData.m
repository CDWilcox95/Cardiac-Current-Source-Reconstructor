function FilterEKGData(frame_ECG)
   ...
   if save_file
       ...
       linelength=fprintf("Filtering ECG Data... \n");

       for l=1:L
           fprintf(repmat('\b',1,linelength))

           linelength=fprintf("Filtering Data on e_l=%d \n", l);
       ...
       fprintf("EKG filter stopped by user.  No data saved \n");
   end
   load(EKG_save_file);
